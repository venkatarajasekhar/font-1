...
typedef VAL_tpValor* VAL_tppValor ;
...
***********************************************************************/
	...
	typedef enum {
			...
			VAL_CondRetCorreto = 1 ,
			/* O valor foi marcado corretamente na linha/coluna */

			VAL_CondRetIncorreto = 2 ,
			/* O valor não foi marcado corretamente na linha/coluna */
